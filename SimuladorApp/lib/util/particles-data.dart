...
class ParticlesData {
  static const Map<Particula, Map<String, double>> data = {
    ...
    Particula.Muon: {'mass': 1.883531627e-28, 'charge': -1.602176565e-19},
    Particula.Tauon: {'mass': 3.16754e-27, 'charge': -1.602176565e-19},
    Particula.Meson: {'mass': 3.16754e-27, 'charge': 1.602176565e-19},
    Particula.Lambda: {'mass': 1.99764e-30, 'charge': 0},
    Particula.Sigma: {'mass': 2.12831, 'charge': 1.602176565e-19},
  };
}
